...
static void MX_UART8_Init(void)
{
  ...
  */
  ...
  /* UART8_TX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_1, LL_DMAMUX1_REQ_UART8_TX);
  ...
  NVIC_SetPriority(UART8_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),3, 0));
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(RESET_FLASH_GPIO_Port, RESET_FLASH_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : RESET_FLASH_Pin */
  GPIO_InitStruct.Pin = RESET_FLASH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RESET_FLASH_GPIO_Port, &GPIO_InitStruct);
